...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-4 md:p-8">
      <div className="flex sm:gap-20 gap-40">
      <h1 className="text-[#263238] text-3xl md:text-3xl font-semibold mb-2 md:mb-0">
        Portfolio
      </h1>
      ...
      <div className="hidden md:flex gap-4 md:gap-5 mt-4 md:mt-0">
        <button
          className="border-black px-4 py-2 border-2 rounded-lg"
          onClick={() => navigate("/sign-in")}
        >
