              ...
              <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4 max-w-[180px] mx-auto">
                  <div className="flex items-center gap-1">
                    <span className="badge-dot" style={{ backgroundColor: "rgb(0,143,251)" }}></span>
                    <span className="font-semibold">Crypto</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="badge-dot" style={{ backgroundColor: "rgb(0,227,150)" }}></span>
                    <span className="font-semibold">Index</span>
                  </div>
                  <div className="flex col-span-2 items-center gap-1">
                    <span className="badge-dot" style={{ backgroundColor: "rgb(254,176,25)" }}></span>
